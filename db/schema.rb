...
ActiveRecord::Schema.define(version: 2021_02_09_074208) do
  ...
  create_table "animelists", force: :cascade do |t|
    ...
    t.index ["anime_id"], name: "index_animelists_on_anime_id"
    t.index ["list_id"], name: "index_animelists_on_list_id"
  end
  ...
  add_foreign_key "lists", "users", column: "owner_id", on_delete: :cascade
end
